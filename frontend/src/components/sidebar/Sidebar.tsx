...
export default function Sidebar({
  ...
  return (
    <div className="h-full flex flex-col bg-[#040816] text-white p-3 md:p-5">
      ...
      <div className="rounded-[24px] md:rounded-[30px] border border-fuchsia-500/20 bg-gradient-to-br from-fuchsia-500/20 to-purple-500/5 p-4 md:p-5 shadow-[0_0_40px_rgba(217,70,239,0.08)]">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div>
            ...
            <h1 className="text-[22px] sm:text-[28px] md:text-[50px] font-extrabold leading-none">
              MedIntel
            </h1>

            <p className="text-[11px] sm:text-[13px] md:text-[30px] text-gray-300 mt-1">
      ...
      <div className="mt-6 md:mt-8 flex-1 overflow-y-auto pr-1 md:pr-2">

        <p className="text-[14px] md:text-[25px] tracking-[2px] md:tracking-[4px] uppercase text-gray-400 mb-4 md:mb-5 font-bold">
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          {conversations.length === 0 && (
            ...
            <div className="text-[15px] md:text-[20px] text-gray-400 bg-white/5 border border-white/10 rounded-3xl p-4 md:p-6 text-center font-bold">
